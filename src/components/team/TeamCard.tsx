    ...
    return (
        <div className="group w-[340px] flex flex-col cursor-pointer">
            ...
            <div className="relative w-full h-[300px] flex items-end justify-center overflow-visible">
                ...
                <div 
                    className="absolute bottom-0 left-0 w-full h-full rounded-tr-[6rem] opacity-0 group-hover:opacity-45 blur-2xl transition-all duration-500 -z-10 pointer-events-none"
            ...
            >
                <div className="relative w-fit">
                    <h3 className="text-[22px] font-black text-gray-900 group-hover:text-black group-hover:translate-x-1 transition-all duration-300 leading-tight tracking-tight">{name}</h3>
                ...
                <p className="text-[13px] font-bold mt-1 group-hover:translate-x-1 transition-all duration-300 delay-75" style={{ color: themeColor }}>{role}</p>
