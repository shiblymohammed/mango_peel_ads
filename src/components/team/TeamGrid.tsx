...
export default function TeamGrid() {
    return (
        <div className="relative z-10 flex flex-wrap justify-center gap-x-14 md:gap-x-20 lg:gap-x-24 gap-y-36 md:gap-y-28 max-w-[1400px] w-full mt-16 md:mt-24 px-4">
